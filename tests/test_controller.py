...
class TestStartupStrategy:
    ...
    async def test_raises_on_max_failures(
        ...
        """Raises MonitorFatalError when cumulative errors reach max_failures."""
...
class TestControlStrategy:
    async def test_raises_on_silence_timeout(self) -> None:
        """Raises when no line arrives within silence_window seconds."""
    ...
    async def test_raises_when_stream_ends(self) -> None:
        """Raises when the async generator is exhausted."""
    ...
    async def test_raises_on_max_failures(self) -> None:
        """Raises after max_failures consecutive error lines."""
